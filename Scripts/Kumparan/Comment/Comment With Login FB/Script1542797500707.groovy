...
'click Trending' 
WebUI.click(findTestObject('Object Repository/WebPage/Home/lblTrending'))
WebUI.click(findTestObject('Object Repository/WebPage/Home/lblTrending1'))
WebUI.scrollToElement(findTestObject('Object Repository/WebPage/TrendingNews/lblTimEditor'), 10)
WebUI.delay(2)
WebUI.setText(findTestObject('WebPage/TrendingNews/txtComment'), ' nice artikel gan')
String komen = WebUI.getText(findTestObject('WebPage/TrendingNews/lblComment'))
log.logInfo(komen)
WebUI.delay(2)
WebUI.verifyElementClickable(findTestObject('Object Repository/WebPage/TrendingNews/btnComment'))
WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/WebPage/TrendingNews/btnComment'))

WebUI.verifyEqual("nice artikel gan ", komen)
